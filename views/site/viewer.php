...
class XIIPMooViewer extends CWidget
{
	...
	protected function registerClientScript()
	{
		...
		// css
		$cs->registerCssFile($baseUrl.'/web/css/iip.css');
		$cs->registerCssFile($baseUrl.'/web/css/ie.css');
		// javascript
		$cs->registerScriptFile($baseUrl.'/web/js/mootools-core-1.3.2-full-nocompat.js', CClientScript::POS_HEAD);
		$cs->registerScriptFile($baseUrl.'/web/js/mootools-more-1.3.2.1.js', CClientScript::POS_HEAD);
		$cs->registerScriptFile($baseUrl.'/web/js/iipmooviewer-2.0'.$this->lang.'.js', CClientScript::POS_HEAD);
		return $baseUrl;
	}
}